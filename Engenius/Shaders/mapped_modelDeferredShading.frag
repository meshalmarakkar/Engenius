...
vec3 CalcPointLight(PointLight light, vec3 viewDir, vec3 fragPos, vec3 norm, vec3 tangentFragPos, mat3 TBN, float shadow, vec3 colour, vec3 specMap);
...
{    
	...
	mat3 TBN;
	TBN[0][0] = TBN_T.x;	TBN[0][1] = TBN_T.y;	TBN[0][2] = TBN_T.z;
